...
class Scheduler : Detail::BaseScheduler<Key>
{
  public:
    ...
    RelativeScheduler<Key, Graph<Key>> add_system(System system);

    template<typename... Systems>
    RelativeScheduler<Key, Graph<Key>> add_group(Systems... systems);

    template<typename... Systems>
    RelativeScheduler<Key, Graph<Key>> add_chain(Systems... systems);
...
template<typename Key>
template<typename System>
RelativeScheduler<Key, Graph<Key>>
